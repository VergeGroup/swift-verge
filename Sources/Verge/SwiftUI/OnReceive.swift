...
extension View {
  ...
  public func onReceiveState<D: DispatcherType>(_ instance: D, perform: @escaping @MainActor (Changes<D.State>) -> Void) {
  ...
  public func onReceiveActivity<D: DispatcherType>(_ instance: D, perform: @escaping @MainActor (D.Activity) -> Void) {
