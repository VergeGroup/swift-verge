...
class VergeGetterRxTests: XCTestCase {
  ...
  func testSimple() {
    ...
    let g = storage.rx.getter(filter: Filters.Historical.init().asFunction(), map: { $0 * 2})
  ...
  func testChain() {
    ...
    var first: RxGetterSource<Int, Int>! = storage.rx.getter(filter: Filters.Historical.init().asFunction(), map: { $0 })
  ...
  func testShare() {
    ...
    let first = storage.rx.getter(filter: Filters.Historical.init().asFunction(), map: { $0 })
  ...
  func testCombine() {
    ...
    let first = storage.rx.getter(filter: Filters.Historical.init().asFunction(), map: { $0 })
    let second = storage.rx.getter(filter: Filters.Historical.init().asFunction(), map: { -$0 })
